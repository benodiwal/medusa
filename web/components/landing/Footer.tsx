...
const Footer = () => {
  return (
    <footer className="relative py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-10" style={{backgroundColor: '#F3F1E8'}}>
      ...
      <div className="max-w-[1380px] mx-auto">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="text-base sm:text-lg mb-8 max-w-xl mx-auto" style={{color: '#6B5B47', opacity: 0.85}}>
